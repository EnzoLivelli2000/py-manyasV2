...
class AddPartyScreen2 extends StatefulWidget {
  ...
  String controllerLocationParty;
  bool fullSize = false;

  AddPartyScreen2({Key key, @required this.image, @required this.controllerTitleParty, @required this.controllerDescriptionParty, @required this.controllerLocationParty});
